...
def write_novelty_update():
    report_p = REPORTS_DIR / "R1C_NOVELTY_UPDATE.md"
    content = """# R1-C §21: Novelty Audit Update
...
"""
    report_p.write_text(content, encoding="utf-8")
    print(f"Saved novelty update to {report_p}")
